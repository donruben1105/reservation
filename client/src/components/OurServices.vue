...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="text-center">
    <p class="text-orange-400 font-semibold">UNWIND SERVICES</p>
    <h1 class="mb-40 text-6xl font-bold">Explore Our Hotel Services</h1>
    ...
    <div class="grid grid-cols-5 gap-4">
      <div class="mb-12 lg:mb-0">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-semibold">Free Wifi</h5>
          </div>
        </div>
      </div>
      ...
      <div class="mb-12 lg:mb-0">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-semibold">Easy Booking</h5>
          </div>
        </div>
      </div>
      ...
      <div class="">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-semibold">Restaurant</h5>
          </div>
        </div>
      </div>
      ...
      <div class="">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-semibold">Swimming Pool</h5>
          </div>
        </div>
      </div>
      ...
      <div class="">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-semibold">Support</h5>
          </div>
        </div>
      </div>
    </div>
