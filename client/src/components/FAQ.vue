...
<div class="container my-24 mx-auto md:px-6">
    ...
    <section class="mb-32">
      ...
      <div class="container mx-auto text-center lg:text-left xl:px-32">
        <h1 class="text-center font-extrabold text-3xl p-12 underline hover:decoration-4 uppercase ">Frequently Ask Question</h1>
        <div class="grid items-center lg:grid-cols-2">
          ...
          <div>
            <img src="https://mdbcdn.b-cdn.net/img/new/ecommerce/vertical/075.jpg"
              class="bg-cover h-[700px] rounded-lg shadow-lg dark:shadow-black/20" alt="" width="660px"/>
          </div>
        </div>
      </div>
      <!-- Jumbotron -->
